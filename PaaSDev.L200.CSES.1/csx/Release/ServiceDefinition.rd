...
<serviceModel xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" name="PaaSDev.L200.CSES.1" generation="1" functional="0" release="0" Id="3bcac04f-e4bd-44c8-a45b-4657b2164f9b" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="PaaSDev.L200.CSES.1Group" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="WebRole1" generation="1" functional="0" release="0" software="C:\Users\piw.FAREAST\source\repos\code\CS\PaaSDev.L200.CSES.1\csx\Release\roles\WebRole1" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="-1" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="0112b597-8108-4c93-b64c-36821edfd433" ref="Microsoft.RedDog.Contract\ServiceContract\PaaSDev.L200.CSES.1Contract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="0708fbff-2dd9-44a5-b996-29089ea7fafe" ref="Microsoft.RedDog.Contract\Interface\WebRole1:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/PaaSDev.L200.CSES.1/PaaSDev.L200.CSES.1Group/WebRole1:Endpoint1" />
          </inPort>
        </interfaceReference>
